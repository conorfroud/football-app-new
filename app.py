...
def team_rolling_averages_new(data1):
    ...
    def create_visualization(df, metric, team, window, green_threshold=1.2, orange_threshold=1.05, flip_colors=False):
        ...
        ax.axvline(x=50.5, color='red', linestyle='--', lw=2, zorder=5)
        ax.axvline(x=45.5, color='#262626', linestyle='--', lw=2, zorder=5)
        ax.axvline(x=-0.5, color='#262626', linestyle='--', lw=2, zorder=5)
